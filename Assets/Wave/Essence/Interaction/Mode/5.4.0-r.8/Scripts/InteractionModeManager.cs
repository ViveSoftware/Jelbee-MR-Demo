...
namespace Wave.Essence.Interaction.Mode
{
	...
	public sealed class InteractionModeManager : MonoBehaviour
	{
		...
		private GameObject RightHand = null, m_RightHandModel = null;
		...
		private GameObject LeftHand = null, m_LeftHandModel = null;
		...
		#region HandManager Settings
		[Tooltip("Select the prior tracker when both natural and electronic trackers are enabled.")]
		[SerializeField]
		...
		[Tooltip("Start the electronic Hand Tracking by default.")]
		[SerializeField]
		private bool m_InitialStartElectronicHand = false;
		...
		private GameObject m_EyeManagerObject = null;
		private EyeManager m_EyeManager = null;
		...
		private void OnEnable()
		{
			if (!mEnabled)
			{
				// Adds the EyeManager for the eye data.
		...
		private void CreateHandModel(HandManager.HandType hand)
		{
		...
		private void CreateHandSelector(HandManager.HandType hand)
		{
