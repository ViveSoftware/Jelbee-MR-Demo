...
namespace Wave.Essence.InputModule.Editor
{
	...
	{
		SerializedProperty m_EyeTracking, m_Eye, m_Movable, m_InputEvent, m_TimeToGaze, m_ButtonControlDevices, m_ButtonControlKeys, m_IgnoreMode;
		...
		public override void OnInspectorGUI()
		{
			...
			if (myScript.EyeTracking)
			{
				EditorGUILayout.HelpBox(
					"Select the eye for gaze.",
					MessageType.Info);
