...
namespace Wave.Essence.ScenePerception.Editor
{
	...
	public class ScenePerceptionManagerEditor : Editor
	{
		...
		static GUIContent Label_TrackingOrigin = new GUIContent("Tracking Origin", "Assign the current Trackign Origin here (e.g. Root of a VR Camera Rig) for pose correction.  If leave it null, this manager will try it set to WaveRig, Camera.main or transform.root.");
